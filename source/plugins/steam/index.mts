...
export default async function ({login, q, imports, data, account}, {token, enabled = false, extras = false} = {}) {
  ...
  try {
    ...
    } = await imports.axios.get(urls.games.owned)
        ...
        games
          ...
          .map(async game => {
            ...
            try {
              ...
              } = await imports.axios.get(`${urls.games.schema}&appid=${game.id}`)
            ...
            try {
              ...
              } = await imports.axios.get(`${urls.games.details}&appids=${game.id}`)
            ...
            try {
              ...
              } = await imports.axios.get(`${urls.player.achievement}&appid=${game.id}`)
