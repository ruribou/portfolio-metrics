  ...
  try {
    ...
    //Languages stats
    {
      ...
      const {
        data: {
          data: {
            matchedUser: {languageProblemCount: languages},
          },
        },
      } = await imports.axios.post("https://leetcode.com/graphql", {variables: {username: user}, query: queries.leetcode.languages()})
    ...
    //Skills stats
    {
      ...
      const {
        data: {
          data: {
            matchedUser: {tagProblemCounts: skills},
          },
        },
      } = await imports.axios.post("https://leetcode.com/graphql", {variables: {username: user}, query: queries.leetcode.skills()})
    ...
    //Problems
    {
      ...
      const {
        data: {
          data: {
            allQuestionsCount: all,
            matchedUser: {
              submitStatsGlobal: {acSubmissionNum: submissions},
            },
          },
        },
      } = await imports.axios.post("https://leetcode.com/graphql", {variables: {username: user}, query: queries.leetcode.problems()})
    ...
    //Recent submissions
    {
      ...
      } = await imports.axios.post("https://leetcode.com/graphql", {variables: {username: user, limit: _limit_recent}, query: queries.leetcode.recent()})
